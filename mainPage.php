...
<body>
	...
	<div class=" div0">
		...
		<div class=" div4">
				<img src="images/main1.jpg" class="img1" name="picture" onmouseover="picture.src='images/main2.jpg'" onmouseout="picture.src='images/main3.jpg'">
		</div>
		<div class=" div5">
			<div class="div5-1"><br/>粉丝</div>
			<?php
			if(!isset($_SESSION['currentuser'])){
					echo "未登录，<a href=\"index.php\" target=\"_parent\">请登录</a>";
				}else{
		...
		<div class="div8">
			<a class="btn btn-primary btn-large theme-release" href="javascript:;">发布微博</a>
		</div>
		<?php
			if(!isset($_SESSION['currentuser'])){
					echo "未登录，<a href=\"index.php\" target=\"_parent\">请登录</a>";
...
<div class="theme-popover">
     ...
     <div class="theme-popbod dform">
                <form class="theme-weibo" name="weiboform" action="releaseWeibo.php" method="post">
                	
                      <textarea name="content" >请在此处输入文本...</textarea> 
                      <br/><br/>
                     <input class="btn btn-primary" type="submit" name="submit" value=" 发 布 " />
                 </form>
     </div>
</div>
<div class="theme-popover-comment">
     ...
     <div class="theme-popbod dform">
                <form class="theme-comment" name="commentform" action="submitComment.php" method="post">
               	 <input type="hidden" name="weiboID" id="wID"/>
                      <textarea name="comment" >请在此处输入评论...</textarea> 
                      <br/><br/>
                     <input class="btn btn-primary" type="submit" name="submit" value=" 确 定 " />
                 </form>
     </div>
</div>
...
<div class="theme-popover-letter">
     ...
     <div class="theme-popbod dform">
                <form class="theme-letter" name="letterform" action="submitLetter.php" method="post">
...
<div class="theme-popover-page">
     ...
     <div class="theme-popbod dform">
                <form class="theme-page" name="pageform" action="submitMain.php" method="post">
                	是否接受私信：<input value="1" checked="checked" type="radio" name="isReceive" />
                	<br/><br/>个人简介:<br/><br/>
